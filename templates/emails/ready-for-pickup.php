...
<p><?php esc_html_e( 'Your order is ready for pickup.', 'woocommerce' ); ?></p>
<h3>Pickup Details</h3>

<p>
Location: <?php echo esc_html(get_option('wc_lpe_settings')['address'] ?? ''); ?><br>
Hours: <?php echo esc_html(get_option('wc_lpe_settings')['hours'] ?? ''); ?><br>
